...
rephrase_system_prompt = (
    ...
    "If the question is Greeting or ask question not related to documents, just return \"none\".\n\n"
    "--- CHAT HISTORY ---\n"
    "{chat_history}"
)
...
qa_system_prompt = (
    ...
    "INSTRUCTIONS:\n"
    "0. If the question is Greeting just introduce yourself by saying \"Hello, I am {persona}, how can I assist you today?\" and don't return any info from context.\n"
    "1. Use the 'RETRIEVED CONTEXT' and 'CHAT HISTORY' provided below to answer only from that the user's question.\n"
    ...
    "4. If the question is not related to the documents, state that it is not relevant and do not answer it.\n"
    "5. If the context doesn't contain the answer, state that you can't find it in the provided documents but offer general insights if appropriate.\n\n"
